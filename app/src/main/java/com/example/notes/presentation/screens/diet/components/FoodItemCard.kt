...
import com.example.notes.ui.theme.foodName
import com.example.notes.ui.theme.foodNutrientCount
import com.example.notes.ui.theme.foodNutrientInformation
import com.example.notes.ui.theme.foodNutrientShort
...
private fun Preview() {
    FoodItemCard(
        food = Food(
            name = "Mashed potatoes with butter and garlic",
            protein = 26.2,
            fat = 0.0,
            carbs = 70.0,
            imageUrl = null
        ),
        onFoodItemClicked = { /*TODO*/ },
        onLongClick = { /*TODO*/ },
